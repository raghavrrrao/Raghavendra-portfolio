...
class RectangleGeometry extends Geometry {
    constructor(width = 20, height = 0.8) {
        ...
        // Add corners
        this.addVertex(-hw, -hh, 0); // bottom-left
        this.lastVertex.uv[0] = 0; this.lastVertex.uv[1] = 0;

        this.addVertex(hw, -hh, 0); // bottom-right
        this.lastVertex.uv[0] = 1; this.lastVertex.uv[1] = 0;

        this.addVertex(hw, hh, 0); // top-right
        this.lastVertex.uv[0] = 1; this.lastVertex.uv[1] = 1;

        this.addVertex(-hw, hh, 0); // top-left
        this.lastVertex.uv[0] = 0; this.lastVertex.uv[1] = 1;

        // Make two triangles for rectangle
        this.addFace(0, 1, 2);
        this.addFace(0, 2, 3);
    }
}
